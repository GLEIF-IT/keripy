...
=======
Then run `docker run --pull=never -it --entrypoint /bin/bash weboftrust/keri:1.1.42` and you can run `kli version` from within the running container to play with KERIpy.
>>>>>>> Stashed changes
