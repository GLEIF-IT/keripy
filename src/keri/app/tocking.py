...
# Poller component tocks, including poller group alias (indirecting.py - Poller)
KERI_POLLER_EVENT_TOCK_KEY = "KERI_POLLER_EVENT_TOCK"
TOCK_ALIASES["pollerEvent"] = TockAlias(
    env=KERI_POLLER_EVENT_TOCK_KEY,
    targets=("pollerConnect", "pollerRequest", "pollerMessage", "pollerIdle"),
)

KERI_POLLER_CONNECT_TOCK_KEY = "KERI_POLLER_CONNECT_TOCK"
KERI_POLLER_REQUEST_TOCK_KEY = "KERI_POLLER_REQUEST_TOCK"
KERI_POLLER_MESSAGE_TOCK_KEY = "KERI_POLLER_MESSAGE_TOCK"
KERI_POLLER_IDLE_TOCK_KEY = "KERI_POLLER_IDLE_TOCK"

TOCKS["pollerConnect"] = Tock(KERI_POLLER_CONNECT_TOCK_KEY, 0.5)
TOCKS["pollerRequest"] = Tock(KERI_POLLER_REQUEST_TOCK_KEY, 0.0)
TOCKS["pollerMessage"] = Tock(KERI_POLLER_MESSAGE_TOCK_KEY, 0.0)
TOCKS["pollerIdle"] = Tock(KERI_POLLER_IDLE_TOCK_KEY, 0.0)
...
TOCKS["respondantCue"] = Tock(KERI_RESPONDANT_CUE_TOCK_KEY, 0.0)
